...
IMAGEM_PASSARO = [pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'bird1.png'))),pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'bird2.png'))),pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'bird3.png')))]
...
def main(genomas, config):
    ...
    while rodando:
        ...
        for i, passaro in enumerate(passaros):
            ...
            # [-1, 1] -> Se o output for > 0.5 o pássaro pula
            if output[0] > 0.5:
                passaro.pular()
